...
//                    alreadySelectedCount = (Constant.selectedFiles.size).coerceAtLeast(0)
//                } else {
//                    alreadySelectedCount = (Constant.selectedFiles.size - 1).coerceAtLeast(0)
//                }
//
//                if (alreadySelectedCount + selected.size >= limit) {
//                    Toast.makeText(
...
//                    (Constant.selectedFiles.size - 1).coerceAtLeast(0)
//
//                val totalSelectedCount = alreadySelectedCount + selected.size
//
//                if (totalSelectedCount >= limit) {
//                    Toast.makeText(
//                        context,
//                        "${context.getString(R.string.You_can_select_up_to)} $limit ${
//                            context.getString(R.string.items_only)
