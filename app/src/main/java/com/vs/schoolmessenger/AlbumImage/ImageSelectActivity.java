        ...
        if (!images.get(position).isSelected && countSelected >= limit) {
            ...
            if (toast == null) {
                toast = Toast.makeText(getApplicationContext(),
                        String.format(getString(R.string.limit_exceeded), limit), Toast.LENGTH_SHORT);
                toast.show();
            }
//            Toast.makeText(
...
//                    .show();
    ...
    private ArrayList<String> getSelected() {
        ...
        for (int i = 0; i < images.size(); i++) {
            ...
            if (images.get(i).isSelected) {
                Log.d("selectedbol", String.valueOf(images.get(i).isSelected));
                Log.d("iget", String.valueOf(images.get(i)));
    ...
    private void sendIntent() {
        Intent intent = new Intent(ImageSelectActivity.this, ReportTheBug.class);
