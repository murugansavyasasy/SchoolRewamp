...
class StaffLeaveRequest : BaseActivity<StaffLeaveRequestBinding>(),
    View.OnClickListener,CustomCalendarFragment.CalendarDateListener{

    override fun getViewBinding(): StaffLeaveRequestBinding {
        return StaffLeaveRequestBinding.inflate(layoutInflater)
    }
    ...
    override fun setupViews() {
        ...
        binding.rytHistory.setOnClickListener {
    ...
    private fun getIntentValuesIfEditing() {
        RequestEdit = intent.getBooleanExtra(Constant.isStaffRequestEdit, false)
