...
import com.vs.schoolmessenger.School.LeaveRequests.LeaveRequestAdapter
...
import com.vs.schoolmessenger.databinding.ApproveStaffLeaveRequestBinding

class ApproveStaffLeaveRequest : BaseActivity<ApproveStaffLeaveRequestBinding>(),
    View.OnClickListener, ApproveStaffLeaveRequestClickListener {

    override fun getViewBinding(): ApproveStaffLeaveRequestBinding {
        return ApproveStaffLeaveRequestBinding.inflate(layoutInflater)
    }

    lateinit var mAdapter: StaffMonthwiseApproveLeaveAdapter
