...
import com.vs.schoolmessenger.Parent.FeeDetails.PaymentProof.FeePaymentProof
...
class FeeDetails :
    BaseActivity<FeeDetailsBinding>(),
    View.OnClickListener,
    InvoiceClickListener {
    ...
    override fun setupViews() {
        ...
        binding.lytViewPaymentProofButton.setOnClickListener(this)
        ...
        val feeUrl =
            Constant.isGlobalVariableData!!.fees_url

        val isFinalFeeUrl =
            feeUrl
                .replace(
                    Constant.isStudentID,
                    isChildId
                )
                .replace(
                    Constant.isSchoolID,
        ...
        Log.d(
            "isFinalFeeUrl",
            "isChildId: $isChildId | " +
                    "isSchoolID: $isSchoolID | " +
                    "StudentFinalFeeUrl: $isFinalFeeUrl"
        )
        ...
        binding.toolbarLayout.lblStudentSection.text =
            isChildDetails!!.standard_name +
                    " - " +
                    isChildDetails!!.section_name

        binding.lblHeaderTitle.text =
            Constant.isSelectedMenuName
        ...
        alertDialogView =
            AlertDialog.Builder(this@FeeDetails).create()



        appViewModel
            ?.apiParentRepositories
            ?.isInvoiceDetails
            ?.observe(this) { response ->
                ...
                if (
                    ...
                    Log.d(
                        "Data",
                        "isResponseStatusComing"
                    )

                    val intent =
                        Intent(
                            this,
                            FeeReceiptViewActivity::class.java
                        )
                    ...
                    Toast.makeText(
                        ...
                        response?.message
                            ?: getString(
                                R.string.unable_to_fetch_invoice
                            ),
                        Toast.LENGTH_SHORT
                    ).show()
                }
                    ...
                    override fun onTextChanged(
                        ...
                        when (isClickedTap) {
                            ...
                            3 -> {
                                ...
                                if (
                                    ::onlinePaymentAdapter.isInitialized
                                ) {
        ...
        appViewModel!!.isFeeInvoices
            ?.observe(this) { response ->
                ...
                if (isClickedTap != 1) {
                    ...
                    Log.d(
                        "FeeDetails_API",
                        "Ignoring Receipt response. " +
                                "Current tab = $isClickedTap"
                    )
                ...
                if (
                    ...
                    // WebView MUST stay hidden
                    binding.webviewContainer.visibility =
                        View.GONE

                    binding.payWebview.visibility =
                        View.GONE


                    // RecyclerView visible
                    binding.rvReceipts.visibility =
                        View.VISIBLE
                    ...
                    binding.lytViewPaymentProofButton.visibility =
                        View.GONE
        ...
        appViewModel!!.isOnlinePaymentResponse
            ?.observe(this) { response ->
                ...
                if (
                        ...
                        OnlinePaymentAdapter(
                            ...
                            object :
                                ...
                                override fun onFilterResult(
                                    ...
                                    // IMPORTANT:
                                    // Adapter callback should
                                    // never modify another tab.
                                    if (isClickedTap != 3) {
                                        return
                                    }


                                    // WebView MUST remain hidden
                                    binding.webviewContainer.visibility =
                                        View.GONE
                    ...
                    onlinePaymentAdapter.updateList(
                        response.data
                    )
                    ...
                    Log.d(
                        "FeeDetails_API",
                        "Transaction API returned no data"
                    )
                }
            }
        ...
        appViewModel!!.isPaymentStatusResponse
            ?.observe(this) { response ->
                ...
                // Only refresh transaction API if
                // user is still on All Transactions.
                if (isClickedTap == 3) {

                    appViewModel?.isOnlinePayment(
                        isAccessToken!!,
                        this
                    )
                }
    ...
    private fun hideKeyboard() {
        ...
        imm.hideSoftInputFromWindow(
            binding.txtSearchMenuBox.windowToken,
            0
        )
    }
    ...
    override fun onClick(
        ...
        when (v?.id) {
            ...
            R.id.btnReceipt -> {
                ...
                Log.d(
                    "FeeDetails_Token",
                    "Fetching invoices with token: $isAccessToken"
                )
            }
            ...
            R.id.lytViewPaymentProofButton -> {

                val intent =
                    Intent(
                        this,
                        FeePaymentProof::class.java
                    )
        ...
        webView.webViewClient =
            object : WebViewClient() {
                ...
                override fun onPageStarted(
                    ...
                    // Only show WebView loading when
    ...
    fun viewInvoice(
        ...
        appViewModel?.getInvoiceDetails(
            isAccessToken!!,
            invoiceId,
            this
        )
    ...
    private fun scrollToMessageId(
        ...
        if (
            ...
            if (index != -1) {
                ...
                Log.d(
                    "ScrollDebug",
                    "No index found for msg_id $msg_id"
                )
            }
        }
    }
    ...
    private fun paymentSuccess(
        ...
        val mobileNumber =
            SharedPreference.getMobileNumber(
                this
            )
        ...
        val jsonObject =
            JsonObject().apply {
                ...
                addProperty(
                    APIKeyNames.mobile_number,
                    mobileNumber
                )

                addProperty(
                    APIKeyNames.activity,
                    Constant.add_points_pay_fees
                )

                addProperty(
                    APIKeyNames.user_type,
                    Constant.user_type_as_parent
                )

                addProperty(
                    APIKeyNames.menu_id,
                    Constant.SELECTED_MENU_ID
                )
            }


        appViewModel?.isAddRewardPoints(
            "",
            jsonObject,
            this
        )
        ...
        if (
            ...
            try {
                ...
                alertDialogView
                    ?.setMessage(
                        getString(
                            R.string.check_if_you_have_upi_apps_installed_or_not
                        )
                    )
