...
class ClassTestAcademicYearAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view =
            LayoutInflater.from(context).inflate(R.layout.new_simple_spinner_item_class, parent, false)
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view =
            LayoutInflater.from(context).inflate(R.layout.new_item_spinner_with_tick, parent, false)
