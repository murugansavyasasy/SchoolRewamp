...
class OnlineMeetingAdapter (
    private var itemList: List<OnlineMeetingData>? = emptyList(),
    private var listener: OnlineMeetingListener,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_SHIMMER) {
            ...
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.online_meeting_parentlist, parent, false)
    ...
    class DataViewHolder(itemView: View, private val context: Context) :
        ...
        fun bind(
            ...
            listener: OnlineMeetingListener,
            position: Int
        ) {
