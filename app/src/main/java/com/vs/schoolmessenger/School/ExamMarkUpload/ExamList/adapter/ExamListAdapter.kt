...
//
////            subjectsRv.layoutManager = LinearLayoutManager(context)
////            subjectsRv.adapter = SubjectListAdapter(item.subjects, context)
//
//            // ---------- EXPAND STATE ----------
//            val isExpanded = position == expandedPosition
//
...
//                    listener.onExamSelected(null,false)   // send null to main activity
//                    return@setOnClickListener
//                }
//
//                // new item selected
...
//            }
//
//            // ---------- Bind SubjectsAdapter once data is available ----------
//            if (isExpanded && !getSubjectActivitiesList.isNullOrEmpty()) {
//                subjectsRv.adapter = SubjectListAdapter(getSubjectActivitiesList!!, context)
//                subjectsRv.visibility = View.VISIBLE
//                lblNoDataFound.visibility = View.GONE
//            } else if (isExpanded) {
