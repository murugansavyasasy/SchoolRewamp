...
//    private lateinit var isHomeWork: ArrayList<GetHomeworkData>
    ...
    override fun setupViews() {
        ...
        isStudentSectionName=isChildDetails?.section_id.toString()
        appViewModel!!.isHomeWorkDetails(
            isAccessToken!!, this
        )

        binding.toolbarLayout.lblStudentName.text = isStudentName
        binding.toolbarLayout.lblStudentSection.text =isStudentStandardName+" "+isStudentSectionName
...
//        loadVoiceData()
    ...
    private fun appendData(newData: ArrayList<GetHomeworkData.GetDateWiseHomeworkData>?) {
