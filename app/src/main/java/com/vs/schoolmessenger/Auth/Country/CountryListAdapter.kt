...
class CountryListAdapter(
    ...
    private var selectedCountryId: Int? = null  // Track selection by ID instead of position
    ...
    inner class CountryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                ...
                selectedCountryId = selectedCountry.id // Save the selected ID

                notifyDataSetChanged() // Refresh all (or could optimize)
        ...
        fun bind(pos: Int, country: Country, isSelected: Boolean) {
            ...
            // Use selection state to update UI
            if (isSelected) {
    ...
    override fun onBindViewHolder(holder: CountryViewHolder, position: Int) {
        ...
        val isSelected = country.id == selectedCountryId //  Selection check by ID
        holder.bind(position, country, isSelected)
    }
