...
object APIMethods {
    ...
    const val updatenotificationcalllog = "comm/api/voice/update-notification-call-log"
    ...
    const val isLogout = "app/api/auth/logout"
    ...
    const val view_marks = "exam/api/new-exam/get-mark-details"
    ...
    const val isDeleteQuizQuestion = "lms/api/quiz/delete-question"
    ...
    const val isGetMessageFromStaffArchive =
        "comm/api/msg-from-management/get-messages-staff-archive"
...
//    const val getSubjectWiseACtivities = "exam/api/new-exam/get-subjectwise-activities" //Old API end point
    ...
    const val isgetfeature = "/dashboard/api/dashboard/features"
...
//    const val savemarks = "exam/api/exam/upload-marks"
    const val savemarks = "exam/api/new-exam/upload-exam-mark"
//    const val getMarkDetails = "exam/api/exam/get-mark-details"
    ...
    const val getcommonremarks = "exam/api/exam-new/common-remarks"
