...
import com.vs.schoolmessenger.School.ExamMarkUpload.ExamList.adapter.SubjectListAdapter
...
class ActivityExamListAdapter(
    private var examList: List<getActivityExamListData>,
    ...
    fun updateData(newList: List<getActivityExamListData>) {
        examList = newList
        isLoading = false
    ...
    inner class ExamViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: getActivityExamListData, position: Int) {

            title.text = item.title
            month.text = item.month

            subjectsRv.layoutManager = LinearLayoutManager(context)
            subjectsRv.adapter = ActivitySubjectListAdapter(item.subjects, context)
